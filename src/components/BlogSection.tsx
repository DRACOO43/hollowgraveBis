        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {BLOG_POSTS.map(post => (
            <div
              ...
              className="group cursor-pointer rounded-3xl bg-neutral-900/60 border border-neutral-800/80 overflow-hidden hover:border-purple-500/50 transition-all duration-500 shadow-xl flex flex-col justify-between backdrop-blur-xl"
            >
