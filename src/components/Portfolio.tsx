        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredItems.map(item => (
            <div
              ...
              className="group cursor-pointer rounded-2xl bg-neutral-900/80 border border-neutral-800/80 overflow-hidden hover:border-purple-500/50 transition-all duration-500 shadow-xl flex flex-col justify-between"
            >
