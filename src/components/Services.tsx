        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredServices.map(service => {
            ...
            return (
              <div
                key={service.id}
                className="group relative rounded-2xl bg-neutral-900/60 border border-neutral-800/80 p-8 hover:border-purple-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-950/30 backdrop-blur-xl flex flex-col justify-between"
              >
